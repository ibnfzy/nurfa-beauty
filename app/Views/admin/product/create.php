...
<div x-data="{
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Tambahkan produk baru ke toko Anda</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <template x-for="(variant, index) in variantItems" :key="index">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <button type="button" @click="removeVariant(index)" class="p-2 text-danger hover:bg-red-50 rounded-lg transition-colors" title="Hapus variant">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-2 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/></svg>
                                    </button>
                                </div>
                            </template>
                        ...
                        <div class="border-t border-gray-100 pt-4">
                            ...
                            <div x-show="isBundle" x-transition class="space-y-4" style="display: none;">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="bundle_discount" name="bundle_discount" value="0" min="0" max="100" step="0.01" class="input-field" placeholder="0">
                                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-primary-light/30 p-6">
                    ...
                    <div>
                        <div x-show="!imagePreview" class="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-primary transition-colors">
                        ...
                        <div x-show="imagePreview" class="relative" style="display: none;">
